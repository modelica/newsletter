...
* A new licensing and deployment model, called <b>[Simcenter&nbsp;X&nbsp;Advanced](https://blogs.sw.siemens.com/simcenter/simcenter-x-advanced-simulation/)</b> that offers ease-of-use and flexibility based on a SaaS approach to licensing.  
