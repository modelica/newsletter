...
In our talk about [**SMArtInt**](https://doi.org/10.3384/ecp218459) "Status of the SMArtInt Library"   we showcased a Modelica realization of the Balanced Neural ODE (BNODE) architecture applied to a ClaRa power plant example, demonstrating the potential of this generic AI-driven non-linear model reduction technique.   
