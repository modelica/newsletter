...
We are delighted to have received so much positive feedback about the [16th International Modelica & FMI Conference](https://modelica.org/events/modelica2025/) in Lucerne. The new format — with dedicated tracks for FMI and related standards as well as for industrial user presentations — proved very successful. Both tracks were well attended, giving the conference a noticeably different character: many participants told us that the event felt more methodologically oriented and encouraged them to engage in exchanges with attendees from different application domains who face similar challenges. This kind of dialogue is exactly what we aim for as a truly multi-domain community.
...
Selecting the awards was no easy task for the conference board: many excellent papers were submitted, and eight free libraries entered the competition. Please have a look at the [corresponding Modelica news item](https://modelica.org/news/2025-10-27-conferenceproceedingsandfreelibraries/). Many existing free libraries also received significant updates. The official [conference proceedings](https://doi.org/10.3384/ecp218) have been published as Linköping Electronic Conference Proceedings (as well as the [proceedings of the Asian Modelica Conference 2024](https://doi.org/10.3384/ecp217)). Many presentations can be found online via the [conference app](https://pretalx.com/16thmodelicafmiconference/schedule/). Selected recodings of the live presentations are currently being processed and will be published soon. 

Once again, I would like to thank our two outstanding [keynote speakers](https://modelica.org/events/modelica2025/#keynotes) Mishra Siddhartha and Johan R Åkesson as well as all participants in the panel discussion. We are very grateful to have received support from our [sponsors](https://modelica.org/events/modelica2025/#sponsors). Most of the credit, however, goes to our local organizer, Prof. Ulf Christian Müller, Ivo Steiner, and the entire team from [HSLU](https://www.hslu.ch/en/). Organizing a conference of this scale is a tremendous effort, and the Modelica Association is truly grateful to have been able to hold its conference in such a marvellous location.

Of course, there is always room for improvement, and we will carry these lessons forward to our upcoming events:

- September 21-22, 2026: [Asian Modelica & FMI Conference](https://modelica.org/events/) in Hangzhou, China
- October 12-14, 2026: [American Modelica & FMI Conference](https://modelica.org/events/) in Atlanta, USA
- September 20-22, 2027: [17th International Modelica & FMI Conference](https://modelica.org/events/) in Prague, Czech Republic
...
- February 2-4: [OpenModelica/MODProd Workshop](https://modprod.github.io/cfp/) in Linköping, Sweden
- May 5, 2026: Modelica in Process Engineering – Community Meetup 2026, Cologne, Germany
- June 15, 2026: [EOOLT Workshop](https://eoolt.org/2026/index.html) on Equation-Based Languages in Bielefeld, Germany
- September 22-23, 2026: [ThermoSim 2026](https://tlk-energy.de/blog-en/thermosim-modeling-simulation-thermal-systems) in Aachen, Germany

…and this list is certainly incomplete. I also encourage you to watch for events from our partner organizations, such as [ASAM](https://www.asam.net/standards/). For me, it is truly wonderful to see so many activities that keep our community vibrant and thriving.
...
To address this, the Modelica Association is proud to have gained [Dr. Rui Gao](https://modelica.org/news/2025-09-05-newsecretaryoftheboard/) (CTO of Nanjing Yuansi SimTek) as our new Secretary of the Board. He is currently focusing on the upcoming Asian Modelica Conference at Beihang University in Hangzhou. Dr. Gao has assembled a large organizing committee that includes tool vendors, industry representatives, academia, and members from Japan and Korea. His work will immediately help strengthen the Asian branch of our community.
