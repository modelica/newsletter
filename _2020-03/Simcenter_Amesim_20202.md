...
# FMI updates
A new ONNX to FMI conversion tool has been introduced. It allows exporting [ONNX](https://onnx.ai/ ) files, either representing a neural network (surrogate model) generated from Simcenter&nbsp;Amesim itself using the Neural Network Builder tool, or pre-trained neural networks coming from other [ONNX](https://onnx.ai/ ) compatible software. The generated FMUs comply with version 2.0.1 of the specification and support the following advanced capabilities: 
...
This new tool represents a first step towards the deployment of highly portable lightweight but accurate representations of physical models&nbsp;&mdash;&nbsp;executable digital twins&nbsp;&mdash;&nbsp;on a wide variety of targets (e.g. IIoT, Edge Computing or Cloud platforms), to serve various kinds of simulation purposes.
