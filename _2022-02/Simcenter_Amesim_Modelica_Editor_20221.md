...
* The standardized **SimcenterAmesim** Modelica library has been upgraded to the version 1.1, containing now the **array** interfaces, **Thermal Hydraulic** interfaces and new demos to show how easy it is to connect these two worlds via standardized physical interfaces.
